package com.joebalogna.dampsmod.sound;
...
public class ModSounds {
    public static final DeferredRegister<SoundEvent> SOUND_EVENTS =
            DeferredRegister.create(ForgeRegistries.SOUND_EVENTS, DampsMod.MOD_ID);
    ...
    public static RegistryObject<SoundEvent> DISCO_LIGHT = registerSoundEvent("disco_light");
    public static RegistryObject<SoundEvent> GASLIGHT = registerSoundEvent("gaslight");
    ...
    private static RegistryObject<SoundEvent> registerSoundEvent(String name) {
        return SOUND_EVENTS.register(name, () -> new SoundEvent(new ResourceLocation(DampsMod.MOD_ID, name)));
    }
